                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form action="ExtDateVessTable.php" method="POST">
                                                                ...
                                                                if (isset($_POST['extendbtn'])) {
                                                                    ...
                                                                    // Define additional variables for passenger_list table
                                                                    ...
                                                                    if ($type == 'cargo') {
                                                                        $update_query = "UPDATE tbl_cargo_record SET DateDD = '$DateDD', PlaceLastDD = '$newPlaceLastDD' WHERE rid = '$id'";
                                                                        $insert_query = "INSERT INTO passenger_list (rid, DateDD, DateInWaterDD, PlaceLastDD, EstDateNextDD) VALUES ('$id', '$DateDD', '0000-00-00', '$newPlaceLastDD', '0000-00-00')";
                                                                    } elseif ($type == 'passenger') {
                                                                        $update_query = "UPDATE tbl_passenger_record SET DateDD = '$DateDD', PlaceLastDD = '$newPlaceLastDD' WHERE id = '$id'";
                                                                        $insert_query = "INSERT INTO passenger_list (rid, DateDD, DateInWaterDD, PlaceLastDD, EstDateNextDD) VALUES ('$id', '$DateDD', '0000-00-00', '$newPlaceLastDD', '0000-00-00')";
                                                                    }
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="hidden" name="DateInWaterDD" class="form-control form-control-sm" >
                                                                            <input type="hidden" name="EstDateNextDD" class="form-control form-control-sm" >
                                                                        </div>
                                                                    </div>
                                                                </div>
