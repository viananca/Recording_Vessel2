                            ...
                            <div class="table-responsive">
                                ...
                                <colgroup>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $i = 1;
                                        $selectAll = $con->query("SELECT * FROM tbl_cargo_record");
                                            while ($cargovess = $selectAll->fetch_assoc()) :
                                                $formattedDate = (new DateTime($cargovess['ExpDateLoadline']))->format('F d, Y');
                                            ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal"  data-target="#editModal-<?php echo $cargovess['rid']; ?>">
                                                View
                                            </button>
                                            <a href="C_record.php?rid=<?php echo $cargovess['rid']; ?>">
                                        ...
                                        <div class="modal fade" id="editModal-<?php echo $cargovess['rid']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel-<?php echo $cargovess['rid']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-xl" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel-<?php echo $cargovess['rid']; ?>">Review Information</h5>
                                                ...
                                                <form action="question_list.php?title_id=<?php //echo $cargovess['rid']; ?>" method="post">
                                                    <?php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 border-right">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="VesselCode" class="form-control form-control-sm" value="<?php echo $cargovess['VesselCode']; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="" class="control-label">Date of DryDock</label>
                                                                <input type="date" name="DateDD" class="form-control form-control-sm" value="<?php echo $cargovess['DateDD'] ? $cargovess['DateDD']: ''; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="" class="control-label">Expiration Date of Loadline</label>
                                                                <input type="date" name="ExpDateLoadline" class="form-control form-control-sm" value="<?php echo $cargovess['ExpDateLoadline'] ? $cargovess['ExpDateLoadline']: ''; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="" class="control-label">Estimated Date of Next DryDock</label>
                                                                <input type="date" name="EstDateNextDD" class="form-control form-control-sm" value="<?php echo $cargovess['EstDateNextDD'] ? $cargovess['EstDateNextDD']: ''; ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="" class="control-label">Vessel Name</label>
                                                                <input type="text" name="Vesselname" class="form-control form-control-sm" value="<?php echo $cargovess['Vesselname']; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="" class="control-label">Date of In-Water DryDock</label>
                                                                <input type="date" name="DateInWaterDD" class="form-control form-control-sm" value="<?php echo $cargovess['DateInWaterDD'] ? $cargovess['DateInWaterDD']: ''; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Place of Last DryDock</label>
                                                                <textarea name="PlaceLastDD" id="" cols="30" rows="4" class="form-control" disabled><?php echo $cargovess['PlaceLastDD']; ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="remarks" class="control-label">Remarks</label>
                                                                <select class="form-control form-control-sm" id="Remarks" name="Remarks" disabled>
                                                                    <option value="" disabled selected>Select Options</option>
                                                                    <option value="Currently at Sangali" <?php echo ($cargovess['Remarks'] == 'Currently at Sangali') ? 'selected' : ''; ?>>Currently at Sangali</option>
                                                                    <option value="On Voyage" <?php echo ($cargovess['Remarks'] == 'On Voyage') ? 'selected' : ''; ?>>On Voyage</option>
                                                                    <option value="Waiting for the requirements" <?php echo ($cargovess['Remarks'] == 'Waiting for the requirements') ? 'selected' : ''; ?>>Waiting for the requirements</option>
                                                                    <option value="Annual DryDock" <?php echo ($cargovess['Remarks'] == 'Annual DryDock') ? 'selected' : ''; ?>>Annual DryDock</option>
                                                                    <option value="Last Extension" <?php echo ($cargovess['Remarks'] == 'Last Extension') ? 'selected' : ''; ?>>Last Extension</option>
                                                                    <option value="On Drydock" <?php echo ($cargovess['Remarks'] == 'On Drydock') ? 'selected' : ''; ?>>On Dry dock</option>
                                                                    <option value="No Operation" <?php echo ($cargovess['Remarks'] == 'No Operation') ? 'selected' : ''; ?>>No Operation</option>
                                                                </select>
                                                            </div>
                                                        </div>
